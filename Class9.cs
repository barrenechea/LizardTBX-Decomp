...
internal sealed class Class9
{
	...
	public static int smethod_35()
	{
		...
		if (int_72 == 0)
		{
			Class9.string_4 = Strings.Left(string_, Strings.InStr(1, string_, "\0") - 1);
